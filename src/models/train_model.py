...
def main(input_data_filepath, input_target_filepath, output_model_filepath, output_validx_filepath):
    ...
    train_data = pd.read_pikle(input_data_filepath)
    train_target= pd.read_pikle(input_target_filepath)

    train_idx, val_idx = train_test_split(train_data, test_size=0.2, random_state=7)
